...
class CreateSSAScreen extends StatefulWidget {
  const CreateSSAScreen({super.key});

  @override
  State<CreateSSAScreen> createState() => _CreateSSAScreenState();
}

class _CreateSSAScreenState extends State<CreateSSAScreen> {
  ...
  Future<void> _createSSA() async {
    ...
    try {
      await AgentGovernanceService.instance.createSSA(
      ...
      if (!mounted) return;
      DialogHelper.showSuccessSnackBar(context, 'SSA created successfully!');
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: _isLoading ? null : _createSSA,
                    icon: _isLoading
                        ? const SizedBox(
                            width: 20,
                            height: 20,
